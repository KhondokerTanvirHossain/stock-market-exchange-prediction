...
file = open("Stocks/cbmx.us.txt", "r") 
dataset = [[]]
count = 0
for line in file:
    tokens = line.split(',')
...
def load():
    test_set = dataset[2800:29000]
    #test_set_scaled = sc.transform(test_set)
    test_set_scaled = dataset_scaled[2800:29000]
...
def senti():
    ...
    return polarity
def run():
    print('Prediction of cbmx Stock Price in Next 10 Days :')
    p =  prediction()
    s = senti()
    print("Date               Price")
    d = 10
